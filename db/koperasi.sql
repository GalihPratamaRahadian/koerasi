...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 09, 2023 at 07:34 AM
...
('A0015', 57, 'Dodi', 'Jalan Padjajaran', '', 'Pegawai swasta', '2023-02-28', '0819234567', 'Cirebon', '2001-08-18', 'aktif', 'Kang Admin', '2023-02-28');
...
(191, 'pokok', 10000, 'A0015', 'Kang Admin', '2023-02-28', '2023-02-28'),
(192, 'sukarela', 50000000, 'A0014', 'Operator Koperasi', '2023-03-01', '2023-03-01');
...
--
ALTER TABLE `t_pengambilan`
  MODIFY `kode_ambil` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `t_simpan`
  MODIFY `kode_simpan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=193;

--
-- AUTO_INCREMENT for table `t_tabungan`
--
ALTER TABLE `t_tabungan`
  MODIFY `kode_tabungan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
COMMIT;
